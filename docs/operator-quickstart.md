# Operator Quickstart — Community Meat Processing

Shortest path from clone to a verified local dry-run for **ISIC 1010** (`cloud-itonami-isic-1010`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1010.git
cd cloud-itonami-isic-1010
```
...
- Blueprint governor key: `meat-processing-governor`
- Likely source path: `meatprocessing.governor.cljc`

...
(require '[cljs.test :as t]
         '[meatprocessing.facts-test]
         '[meatprocessing.governor-test]
         '[meatprocessing.phase-test]
         '[meatprocessing.registry-test]
         '[meatprocessing.store-test])

(defmethod t/report [:cljs.test/default :end-run-tests] [m]
  (when-not (t/successful? m) (set! (.-exitCode js/process) 1)))

(t/run-tests 'meatprocessing.facts-test
              'meatprocessing.governor-test
              'meatprocessing.phase-test
              'meatprocessing.registry-test
              'meatprocessing.store-test)
